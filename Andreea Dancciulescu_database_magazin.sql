...
-- Dumping structure for table bookstore.book_authors
...
-- Dumping structure for table bookstore.book_genres
...
-- Dumping structure for table bookstore.genres
...
-- Dumping structure for table test1.clienti
CREATE TABLE IF NOT EXISTS `clienti` (
  `ID_C` int NOT NULL,
  `Nume` varchar(200) NOT NULL,
  `Prenume` varchar(200) DEFAULT NULL,
  `Email` varchar(200) NOT NULL,
  `Nr_telefon` char(50) DEFAULT NULL,
  PRIMARY KEY (`ID_C`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table test1.comenzi
CREATE TABLE IF NOT EXISTS `comenzi` (
  `ID_comanda` int NOT NULL,
  `ID_C` int NOT NULL,
  `ID` int NOT NULL,
  `ID_P` int NOT NULL,
  `Nr_bucati` int DEFAULT NULL,
  `Data_achizitiei` date DEFAULT NULL,
  PRIMARY KEY (`ID_comanda`),
  KEY `ID_C` (`ID_C`),
  KEY `ID` (`ID`),
  KEY `ID_P` (`ID_P`),
  CONSTRAINT `comenzi_ibfk_1` FOREIGN KEY (`ID_C`) REFERENCES `clienti` (`ID_C`),
  CONSTRAINT `comenzi_ibfk_2` FOREIGN KEY (`ID`) REFERENCES `table_produse` (`ID`),
  CONSTRAINT `comenzi_ibfk_3` FOREIGN KEY (`ID_P`) REFERENCES `personal` (`ID_P`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Data exporting was unselected.

-- Dumping structure for table test1.personal
CREATE TABLE IF NOT EXISTS `personal` (
  `ID_P` int NOT NULL,
  `Nume` varchar(200) NOT NULL,
  `Prenume` varchar(200) DEFAULT NULL,
  `Functia` varchar(200) NOT NULL,
...
-- Dumping structure for table test1.table_produse
CREATE TABLE IF NOT EXISTS `table_produse` (
  `ID` int NOT NULL,
  `Descriere` varchar(200) NOT NULL,
  `Pret` int NOT NULL,
  `Stoc_bucati` int DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
